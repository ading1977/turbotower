...
const (
	format_get_containerpod_header  = "%-60s%-10s%-10s%-15s%-10s\n"
	format_get_containerpod_content = "%-60s%-10.2f%-10.2f%-15.2f%-10.2f\n"
)
...
func GetContainerPod(c *cli.Context) error {
	...
	fmt.Printf(format_get_containerpod_header,
	...
	for _, entity := range tp.Entities {
		...
		fmt.Printf(format_get_containerpod_content,
